              ...
              >
                ...
                <div 
                  ...
                  style={{
                    ...
                    >
                      Наши овцы круглый год проводят время на{'\u00A0'}чистых лугах, питаясь свежими травами. Зимой их{'\u00A0'}рацион дополняют качественное сено и{'\u00A0'}зерновые корма. Мы{'\u00A0'}заботимся о{'\u00A0'}здоровье животных, используем только необходимый минимум ветеринарных препаратов и{'\u00A0'}следим за{'\u00A0'}естественными условиями содержания. Благодаря такому подходу мясо и{'\u00A0'}шерсть овец получаются нежными, ароматными и{'\u00A0'}по-настоящему натуральными{'\u00A0'}—{'\u00A0'}результат уважения к{'\u00A0'}природе и{'\u00A0'}кропотливой работы.
                  </p>
          </div>
        </div>
          ...
          style={{
            ...
            style={{
              ...
              style={{
                    ...
                    >
                      Наша птица растёт на{'\u00A0'}свободном выгуле и{'\u00A0'}получает сбалансированное натуральное питание без лишних добавок. Мы{'\u00A0'}создаём условия, максимально близкие к{'\u00A0'}естественным. Такой уход делает мясо особенно сочным и{'\u00A0'}вкусным.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="padding-global">
          <div className="container-medium"
            ...
            >
              ...
              >
                Мы{'\u00A0'}— семья, которая решила сохранить родовую землю и{'\u00A0'}вдохнуть жизнь в{'\u00A0'}традиции предков. В{'\u00A0'}самом сердце Воронежской области, там, где жили наши бабушки и{'\u00A0'}дедушки, мы{'\u00A0'}создали ферму{'\u00A0'}— и{'\u00A0'}вместе с{'\u00A0'}ней будущее для наших детей. Здесь каждое животное{'\u00A0'}— часть большой истории, а{'\u00A0'}каждый день наполнен трудом, любовью и{'\u00A0'}вниманием к{'\u00A0'}природе.
              </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Родная земля{'\u00A0'}— источник силы и{'\u00A0'}вдохновения. Наша ферма находится в{'\u00A0'}селе Аношкино Лискинского района Воронежской области. Это земля наших предков, которая хранит память поколений. Здесь{'\u00A0'}— простор, тишина и{'\u00A0'}настоящая деревенская жизнь.
                </p>
              </div>
